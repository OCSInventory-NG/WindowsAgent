...
#define SUCCESS_ALREADY_SETUP	_T( "SUCCESS_ALREADY_SETUP")
...
#define ERR_EXECUTE_NO_EXIT_CODE _T( "ERR_EXECUTE_NO_EXIT_CODE")
#define ERR_EXECUTE_TIMEOUT		_T( "ERR_EXECUTE_TIMEOUT")
#define ERR_EXECUTE_TOO_MANY_ERRORS _T( "ERR_EXECUTE_TOO_MANY_ERRORS")
/* No more used
