                        ...
                        if (pszToken)
                        {
                          ...
                          if (pszToken)
                          {
                            ...
                            if (pszToken)
                            {
                              ...
                              //CSDVersion string, UBR and ProductType and SemiAnnual are optional so consider it successful if we got as far as here
                              bSuccess = TRUE;
...
{
  if (bCheckUnderlying)
    return IsWindowsServer2019(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwUnderlyingBuildNumber >= 18204) && (lpVersionInformation->dwUnderlyingBuildNumber <= 18362) && lpVersionInformation->bSemiAnnual;
  else
    return IsWindowsServer2019(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwEmulatedBuildNumber >= 18204) && (lpVersionInformation->dwEmulatedBuildNumber <= 18362) && lpVersionInformation->bSemiAnnual;
}

_Success_(return != FALSE) BOOL COSVersion::IsWindowsServerCodename19H2(_In_ LPCOS_VERSION_INFO lpVersionInformation, _In_ BOOL bCheckUnderlying)
{
  if (bCheckUnderlying)
    return IsWindowsServer2019(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwUnderlyingBuildNumber > 18362) && lpVersionInformation->bSemiAnnual;
  else
    return IsWindowsServer2019(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwEmulatedBuildNumber > 18362) && lpVersionInformation->bSemiAnnual;
}
...
{
  if (bCheckUnderlying)
    return IsWindows10(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwUnderlyingBuildNumber > 17763) && (lpVersionInformation->dwUnderlyingBuildNumber <= 18362);
  else
    return IsWindows10(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwEmulatedBuildNumber > 17763) && (lpVersionInformation->dwEmulatedBuildNumber <= 18362);
}

_Success_(return != FALSE) BOOL COSVersion::IsWindows10Codename19H2(_In_ LPCOS_VERSION_INFO lpVersionInformation, _In_ BOOL bCheckUnderlying)
{
  if (bCheckUnderlying)
    return IsWindows10(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwUnderlyingBuildNumber > 18362) && (lpVersionInformation->dwUnderlyingBuildNumber < 18836);
  else
    return IsWindows10(lpVersionInformation, bCheckUnderlying) && (lpVersionInformation->dwEmulatedBuildNumber > 18362) && (lpVersionInformation->dwUnderlyingBuildNumber < 18836);
}
