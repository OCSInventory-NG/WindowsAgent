...
//functions are not completely mutually exlusive
  ...
  _Success_(return != FALSE) BOOL IsWindows10Codename19H2(_In_ LPCOS_VERSION_INFO lpVersionInformation, _In_ BOOL bCheckUnderlying);
  ...
  _Success_(return != FALSE) BOOL IsWindowsServerCodename19H2(_In_ LPCOS_VERSION_INFO lpVersionInformation, _In_ BOOL bCheckUnderlying);
